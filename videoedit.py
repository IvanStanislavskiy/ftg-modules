...
@loader.tds
class VideoEditMod(loader.Module):
    'Module for working with video'

    strings = {
        "name": "Sony Vegas",
        "downloading": "<b>[{}]</b> Спиздил...",
        "working": "<b>[{}]</b> Обрабатываю антисептиком... ",
        "exporting": "<b>[{}]</b> Сохраняю какашку...",
        "set_value": "<b>[{}]</b> Выбери номер от {} до {}...",
        "reply": "<b>[{}]</b> В бутыльню поддерживаются только ~Видеофайлы~ и ~GIF~!",
        "set_time": "<b>[{}]</b> Укажи время в порядке start(ms):end(ms)",
        "set_link": "<b>[{}]</b> Дай ссылОчку...",
    }
